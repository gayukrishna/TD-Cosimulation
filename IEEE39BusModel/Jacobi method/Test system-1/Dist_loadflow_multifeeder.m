function [S_phckt24sub]=Dist_loadflow_multifeeder(Cktnum,T1,V_asub,V_bsub,V_csub,V_aangsub,V_bangsub,V_cangsub)
...
if Cktnum == 25
fid=fopen('C:\Users\user\Dropbox\personal\MATLABCODES\cosim_codes\Codes\bigger_model\Simple_case\ckt24_multifeeder\Interfacevoltage.txt','w');
%fid=fopen('C:\Users\user\Dropbox\personal\MATLABCODES\cosim_codes\Codes\bigger_model\Simple_case\ckt24_unbalance\Interfacevoltage.txt','w');
...
if Cktnum == 25
DSSText.Command='Compile (C:\Users\user\Dropbox\personal\MATLABCODES\cosim_codes\Codes\bigger_model\Simple_case\ckt24_multifeeder\master_ckt24_cosim.dss)';
%DSSText.Command='Compile (C:\Users\user\Dropbox\personal\MATLABCODES\cosim_codes\Codes\bigger_model\Simple_case\ckt24_unbalance\master_ckt24_cosim.dss)';
