...
% a_bus6=[a_bus6;V_asub_bus6 V_bsub_bus6 V_csub_bus6 V_aangsub_bus6 V_bangsub_bus6 V_cangsub_bus6 real(S_phckt24sub_bus6(1,1)) real(S_phckt24sub_bus6(2,1)) real(S_phckt24sub_bus6(3,1)) imag(S_phckt24sub_bus6(1,1)) imag(S_phckt24sub_bus6(2,1)) imag(S_phckt24sub_bus6(3,1))]
% a_bus5=[a_bus5;V_asub_bus5 V_bsub_bus5 V_csub_bus5 V_aangsub_bus5 V_bangsub_bus5 V_cangsub_bus5 real(S_phckt24sub_bus5(1,1)) real(S_phckt24sub_bus5(2,1)) real(S_phckt24sub_bus5(3,1)) imag(S_phckt24sub_bus5(1,1)) imag(S_phckt24sub_bus5(2,1)) imag(S_phckt24sub_bus5(3,1))]
% a_bus8=[a_bus8;V_asub_bus8 V_bsub_bus8 V_csub_bus8 V_aangsub_bus8 V_bangsub_bus8 V_cangsub_bus8 real(S_phckt24sub_bus8(1,1)) real(S_phckt24sub_bus8(2,1)) real(S_phckt24sub_bus8(3,1)) imag(S_phckt24sub_bus8(1,1)) imag(S_phckt24sub_bus8(2,1)) imag(S_phckt24sub_bus8(3,1))]
% 
% r_bus6=abs([r_bus6;R_matrix(1,1) R_matrix(2,1) R_matrix(3,1) R_matrix(4,1) R_matrix(5,1) R_matrix(6,1) R_matrix(19,1) R_matrix(20,1) R_matrix(21,1)]) 
% r_bus5=abs([r_bus5;R_matrix(7,1) R_matrix(8,1) R_matrix(9,1) R_matrix(10,1) R_matrix(11,1) R_matrix(12,1) R_matrix(22,1) R_matrix(23,1) R_matrix(24,1)]) 
% r_bus8=abs([r_bus8;R_matrix(13,1) R_matrix(14,1) R_matrix(15,1) R_matrix(16,1) R_matrix(17,1) R_matrix(18,1) R_matrix(25,1) R_matrix(26,1) R_matrix(27,1)]) 
% disp('..........................................................');
